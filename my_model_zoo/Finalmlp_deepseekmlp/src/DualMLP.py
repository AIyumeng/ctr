...
class DualMLP(BaseModel):
    def __init__(self, 
        ...
        self.mlp1 = Deepseek_MLP_Block(input_dim=embedding_dim * feature_map.num_fields,
                              output_dim=1, 
        ...
        self.mlp2 = Deepseek_MLP_Block(input_dim=embedding_dim * feature_map.num_fields,
                              output_dim=1, 
