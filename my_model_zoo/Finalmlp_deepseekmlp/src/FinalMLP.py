...
from fuxictr.pytorch.layers import FeatureEmbedding, Deepseek_MLP_Block
...
class FinalMLP(BaseModel):
    def __init__(self, 
        ...
        self.mlp1 = Deepseek_MLP_Block(input_dim=feature_dim,
                              output_dim=None, 
        ...
        self.mlp2 = Deepseek_MLP_Block(input_dim=feature_dim,
                              output_dim=None, 
...
class FeatureSelection(nn.Module):
    def __init__(self, feature_map, feature_dim, embedding_dim, fs_hidden_units=[], 
        ...
        self.fs1_gate = Deepseek_MLP_Block(input_dim=embedding_dim * max(1, len(fs1_context)),
                                  output_dim=feature_dim,
                                  hidden_units=fs_hidden_units,
                                  hidden_activations="ReLU",
                                  output_activation="Sigmoid",
                                  batch_norm=False)
        self.fs2_gate = Deepseek_MLP_Block(input_dim=embedding_dim * max(1, len(fs2_context)),
                                  output_dim=feature_dim,
                                  hidden_units=fs_hidden_units,
                                  hidden_activations="ReLU",
                                  output_activation="Sigmoid",
